...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        simpleItem(ModItems.FIRE_SCYTH);
        ...
        simpleItem(ModItems.WATER_SCROLL);
        simpleItem(ModItems.WATER_SCROLL_TIER_2);
        simpleItem(ModItems.EARTH_SCROLL_TIER_2);
        simpleItem(ModItems.FIRE_SCROLL_TIER_2);
        simpleItem(ModItems.LIGHTNING_SCROLL_TIER_2);
        simpleItem(ModItems.WATER_SCROLL_TIER_3);
        simpleItem(ModItems.EARTH_SCROLL_TIER_3);
        simpleItem(ModItems.FIRE_SCROLL_TIER_3);
        simpleItem(ModItems.LIGHTNING_SCROLL_TIER_3);
        simpleItem(ModItems.WATER_SCROLL_TIER_4);
        simpleItem(ModItems.EARTH_SCROLL_TIER_4);
        simpleItem(ModItems.FIRE_SCROLL_TIER_4);
        simpleItem(ModItems.LIGHTNING_SCROLL_TIER_4);
