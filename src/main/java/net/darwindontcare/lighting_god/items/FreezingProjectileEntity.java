...
public class FreezingProjectileEntity extends Snowball {
    ...
    private static final int FREEZE_DAMAGE = 5;
    ...
    private void FreezeEntity(LivingEntity entity, Entity owner, Entity projectile, ServerLevel serverLevel) {
        if (!entity.equals(owner)) {
            ...
            boolean placedIce1;
            boolean placedIce2;
            if (!level.getBlockState(new BlockPos((int) entity.position().x, (int) entity.position().y, (int) entity.position().y)).getMaterial().isSolid()) {
                placedIce1 = level.setBlock(new BlockPos((int) entity.position().x, (int) entity.position().y, (int) entity.position().z), Blocks.PACKED_ICE.defaultBlockState(), 3);
                if (placedIce1) level.gameEvent(owner, GameEvent.BLOCK_PLACE, new BlockPos((int) entity.position().x, (int) entity.position().y, (int) entity.position().z));
            } else {
                placedIce1 = false;
            }
            if (!level.getBlockState(new BlockPos((int)entity.position().x, (int) (entity.position().y + entity.getEyeHeight()), (int)entity.position().z)).getMaterial().isSolid()) {
                placedIce2 = level.setBlock(new BlockPos((int)entity.position().x, (int) (entity.position().y + entity.getEyeHeight()), (int)entity.position().z), Blocks.PACKED_ICE.defaultBlockState(), 3);
                if (placedIce2) level.gameEvent(owner, GameEvent.BLOCK_PLACE, new BlockPos((int) entity.position().x, (int) (entity.position().y + entity.getEyeHeight()), (int) entity.position().z));
            } else {
                placedIce2 = false;
            }
            ...
            new Thread(() -> {
                ...
                try {
                    ...
                    runnable.interrupt();
                    if (placedIce1) {
                        level.destroyBlock(new BlockPos((int) affectedEntityPos.x, (int) affectedEntityPos.y, (int) affectedEntityPos.z), true);
                        level.gameEvent(owner, GameEvent.BLOCK_DESTROY,new BlockPos((int) affectedEntityPos.x, (int) affectedEntityPos.y, (int) affectedEntityPos.z));}
                    if (placedIce2) {
                        level.destroyBlock(new BlockPos((int) affectedEntityPos.x, (int) (affectedEntityPos.y + entity.getEyeHeight()), (int) affectedEntityPos.z), true);
                        level.gameEvent(owner, GameEvent.BLOCK_DESTROY,new BlockPos((int) affectedEntityPos.x, (int) (affectedEntityPos.y + entity.getEyeHeight()), (int) affectedEntityPos.z));
                    }
